                            ...
                            <div class="event_inner">
                                <div class="team-aria team-first">          
                                    <div class="alba-team_logo">
                                        <amp-img alt="{{$m->equipe_home}}" src="{{ asset('images/barcelone.png') }}"  width="35" height="35"></amp-img>
                                    </div>
                                ...
                                <div class="event_title_wrapper">
                                    ...
                                    <div class="alba-team_logo">
                                        <amp-img alt="{{$m->equipe_away}}" src="{{ asset('images/Alaves.png') }}" width="35" height="35"></amp-img>
                                    </div>
